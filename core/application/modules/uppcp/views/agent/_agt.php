...
switch ($marital_status) {
	case 1:
		$point .= '<p style="top:306px; left:153px; font-size:16px"><img src="'.FCPATH.'assets/img/ok.png" style="width: 6mm; height: 6.5mm; margin: 0;"></p>';
	break;
	case 2:
		$point .= '<p style="top:306px; left:211px; font-size:16px"><img src="'.FCPATH.'assets/img/ok.png" style="width: 6mm; height: 6.5mm; margin: 0;"></p>';
	break;
	case 3:
		$point .= '<p style="top:306px; left:281px; font-size:16px"><img src="'.FCPATH.'assets/img/ok.png" style="width: 6mm; height: 6.5mm; margin: 0;"></p>';
	break;
	case 4:
		$point .= '<p style="top:306px; left:346px; font-size:16px"><img src="'.FCPATH.'assets/img/ok.png" style="width: 6mm; height: 6.5mm; margin: 0;"></p>';
	break;
	default:
		$point .= '';
}
