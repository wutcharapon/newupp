...
$pagecount = $mpdf->setSourceFile(APPPATH.'libraries/mpdf/template/agt.pdf');

$fullname = (isset($regis['fullname'])) ? $regis['fullname'] : "";
$agt_idcard = (isset($regis['agt_idcard'])) ? $regis['agt_idcard'] : "";
$date_birth = (isset($regis['date_birth']) and $regis['date_birth'] != '1957-01-01') ? $regis['date_birth'] : "";
...
$point = '
	...
	<!----------------->
	<p style="top:170px; left:250px; ">'.$fullname.'</p>
	...
	<p style="top:235px; left:340px;">'.$date_expiry.'</p>
	<p style="top:235px; left:520px;">'.$date_birth.'</p>
	...
	<p style="top:333px; left:160px; ">'.$marital_name.'</p>
	<p style="top:333px; left:480px; ">'.$marital_tel.'</p>

	<p style="top:367px; left:204px; ">'.$addressed.'</p>

	<p style="top:400px; left:350px; ">'.$zipcode.'</p>
	<p style="top:400px; left:480px; ">'.$tel.'</p>

	<p style="top:432px; left:153px; ">'.$email_address.'</p>
	<p style="top:432px; left:495px; ">'.$id_line.'</p>

	<p style="top:465px; left:175px; ">'.$guarantor.'</p>

	<p style="top:499px; left:178px; ">'.$guarantor_address.'</p>

	<p style="top:530px; left:350px; ">'.$guarantor_zipcode.'</p>
	<p style="top:530px; left:498px; ">'.$guarantor_tel.'</p>

	<p style="top:563px; left:204px; ">'.$guarantor_workphoe.'</p>
	<p style="top:563px; left:498px; ">'.$guarantor_mobile.'</p>
...
switch ($marital_status) {
	case 1:
		$point .= '<p style="top:306px; left:153px; font-size:16px"><img src="'.base_url('assets/img/ok.png').'" style="width: 6mm; height: 6.5mm; margin: 0;"></p>';
	break;
	case 2:
		$point .= '<p style="top:306px; left:211px; font-size:16px"><img src="'.base_url('assets/img/ok.png').'" style="width: 6mm; height: 6.5mm; margin: 0;"></p>';
	break;
	case 3:
		$point .= '<p style="top:306px; left:281px; font-size:16px"><img src="'.base_url('assets/img/ok.png').'" style="width: 6mm; height: 6.5mm; margin: 0;"></p>';
	break;
	case 4:
		$point .= '<p style="top:306px; left:346px; font-size:16px"><img src="'.base_url('assets/img/ok.png').'" style="width: 6mm; height: 6.5mm; margin: 0;"></p>';
	break;
	default:
		$point .= '';
}
...
if($was_agt == 'Y') {
	$point .= '
		<p style="top:760px; left:79px; font-size:16px"><img src="'.base_url('assets/img/ok.png').'" style="width: 6mm; height: 6.5mm; margin: 0;"></p>
		<p style="top:755px; left:175px;">'.$was_agtno.'</p>
	';
} else {
	$point .= '
		<p style="top:730px; left:79px; font-size:16px"><img src="'.base_url('assets/img/ok.png').'" style="width: 6mm; height: 6.5mm; margin: 0;"></p>
	';
}
