    ...
    <div class="container my-3">
		...
		<div class="breadcrumb-wrapper">
            <ol class="breadcrumb">
              ...
              <li>
                <a href="<?=base_url('other_insurance')?>">การประกันภัยเบ็ดเตล็ด</a>
              </li>
            </ol>
        </div>
      ...
      <div class="card">
        <div class="card-body">
          <div class="row">
			...
			<div class="col-12 mb-2">
              <h3 class="button"><i class="fa fa-cogs" aria-hidden="true"></i> การประกันภัยเบ็ดเตล็ด</h3>
			  <hr>
			  <p>เป็นการประกันภัยแบบต่างๆ ซึ่งไม่จัดอยู่ในการประกันอัคคีภัย การประกันภัยทางทะเลและขนส่งหรือการประกันภัยรถยนต์ ได้แก่</p>
            </div>
		<?php if (empty($other)) { ?>
		...
		<?php } else { ?> 
            ...
            <div class="col-md-8 offset-sm-2 mb-3 mb-md-0 form-content">
              ...
              <form class="form-style-1" id='form' method="post" action="<?=base_url('other_insurance/send')?>" >
                <div class="form-row">
