    ...
    <div class="container my-3">
		...
		<div class="breadcrumb-wrapper">
            <ol class="breadcrumb">
              ...
              <li>
                <a href="<?=base_url('fire_insurance')?>">การประกันอัคคีภัย</a>
              </li>
            </ol>
        </div>
        ...
        <div class="card-body">
          <div class="row">
			...
			<div class="col-12 mb-2">
              <h3 class="button"><i class="fa fa-cogs" aria-hidden="true"></i> การประกันอัคคีภัยและการประกันภัยทรัพย์สิน</h3>
			  <hr>
			  <p>การจัดทำประกันภัยถือ เป็นทางเลือกหนึ่งในการโอนความเสี่ยงทางด้าน การเงินสำหรับทรัพย์สินที่คุณรักและ ธุรกิจที่คุณสร้างและทุ่มเทให้ทั้งชีวิต โดยสามารถจัดแบ่งออกเป็นประเภทใหญ่ๆ ได้ดังนี้</p>
			  <?php foreach ($fire as $post) {
				echo $post['descript'];
			  }?>
            ...
            <div class="col-md-8 offset-sm-2 mb-3 mb-md-0">
              ...
              <form class="form-style-1" id='form' method="post" action="<?=base_url('fire_insurance/send')?>" >
                <div class="form-row">
				<input type="hidden" class="form-control" name="positionId" value="การประกันอัคคีภัย">
