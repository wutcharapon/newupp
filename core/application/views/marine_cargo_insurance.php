    ...
    <div class="container my-3">
		...
		<div class="breadcrumb-wrapper">
            <ol class="breadcrumb">
              ...
              <li>
                <a href="<?=base_url('marine_cargo_insurance')?>">การประกันภัยทางทะเลและขนส่ง </a>
              </li>
            </ol>
        </div>
      ...
      <div class="card">
        <div class="card-body">
          <div class="row">
			...
			<div class="col-12 mb-2">
              <h3 class="button"><i class="fa fa-cogs" aria-hidden="true"></i> การประกันภัยทางทะเลและขนส่ง</h3>
			  <p>คือการประกันภัยที่ให้ความคุ้มครองสินค้าในระหว่างขนส่งจากประเทศหนึ่งไปยังอีกประเทศหนึ่ง เนื่องจากภัยอันตราย และความเสียหายต่อสินค้าที่ทำการขนส่ง ไม่ว่าโดยทางเรือ ทางอากาศ ทางบก หรือทางพัสดุไปรษณีย์ โดยทั่วไปเรียกโดยรวมว่าการประกันภัยขนส่งสินค้าทางทะเล หรือ Marine Cargo Insurance</p>
			  <hr>
            </div>
		<?php if (empty($marine_cargo)) { ?>
		...
		<?php } else { ?> 
            ...
            <div class="col-md-8 offset-sm-2 mb-3 mb-md-0 form-content">
              ...
              <form class="form-style-1" id='form' method="post" action="<?=base_url('marine_cargo_insurance/send')?>" >
                <div class="form-row">
                    ...
                    <label>ผลิตภัณฑ์ที่สนใจ</label>
					  <span class="input-icon">
						...
						<select class="form-control" name="pdname" data-validation="required">
							...
							<?php foreach ($marine_cargo as $select) { ?>
			...
			<div class="col-lg-12 col-md-12">
				...
				<?php $n=1; foreach ($marine_cargo as $post) { ?>
						  ...
						  <div class="card card-2col text-primary zoom-hover">
							...
							<div class="card-img-overlay flex-center-top flex-column">
							  ...
							  <a href="#" class="bin-position" data-position='<?=$post['title']?>'><button class="btn btn-sm rounded-pill btn-outline-primary atc-demo">สนใจผลิตภัณฑ์นี้</button></a>
							</div>
						  </div>
