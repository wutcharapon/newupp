    ...
    <div class="container my-3">
		...
		<div class="breadcrumb-wrapper">
            <ol class="breadcrumb">
              ...
              <li>
                <a href="<?=base_url('freedom_insurance')?>">การประกันภัยอิสรภาพ</a>
              </li>
            </ol>
        </div>
        ...
        <div class="card-body">
          <div class="row">
			...
			<div class="col-12 mb-2">
              <h3 class="button"><i class="fa fa-cogs" aria-hidden="true"></i> การประกันภัยอิสรภาพ</h3>
			  <hr>
			  <p>การประกันภัยอิสรภาพ เป็นการประกันภัยที่จัดทำขึ้นโดยมีแนวความคิดจากการที่ศาลยุติธรรมจะจัดระบบ การประกันตัวผู้ต้องหาหรือจำเลย โดยเพิ่มทางเลือกให้แก่ประชาชนในการหาหลักประกันมาวางศาล เนื่องจากปัจจุบันมีคดีอาญาเกิดขึ้นจำนวนมาก</p>
			  <p>ศาลยุติธรรม สำนักงานอัยการสูงสุด สำนักงานตำรวจแห่งชาติ กรมการประกันภัยกระทรวงพาณิชย์ และสมาคมประกันวินาศภัย จึงได้ร่วมกันจัดทำกรมธรรม์ประกันภัยอิสรภาพและอัตราเบี้ยประกันภัยสำหรับ การประกันภัยดังกล่าวขึ้น</p>
            </div>
            ...
            <div class="col-md-8 offset-sm-2 mb-3 mb-md-0">
              ...
              <form class="form-style-1" id='form' method="post" action="<?=base_url('freedom_insurance/send')?>" >
                <div class="form-row">
				<input type="hidden" class="form-control" name="positionId" value="การประกันภัยอิสรภาพ">
